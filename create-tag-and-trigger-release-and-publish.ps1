...
[string]$githubProjectUrl = 'https://github.com/CompuMasterGmbH/CompuMaster.Console/' #must contain trailing slash!
[string]$masterBranchName = "master" #ususally 'master' or 'main'
[string]$assemblyVersionSourceFilePath = ".\Console\CompuMaster.Console.vbproj"
